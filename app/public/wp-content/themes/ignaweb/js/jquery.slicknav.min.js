  ...
  (a.prototype.init = function () {
    ...
    if (
      ...
      var c = e(
        '<div class="' +
          l +
          '_brand"><a href="' +
          slickNavVars.ng_slicknav.ng_slicksearch +
          '"><img src="' +
          r.brand +
          '" alt="' +
          slickNavVars.ng_slicknav.ng_slicknav_alt +
          '" /></a></div>'
      );
      e(a).append(c);
    }
    (i.btn = e(
      [
        '<' +
          ...
          l +
          '_collapsed">',
        '<span class="' + l + '_menutxt">' + r.label + '</span>',
        '<span class="' + n + '">',
    ...
    e(p).each(function () {
      ...
      if (
        ...
        r.allowParentLinks &&
          ...
          (p = p.wrap(c).parent()),
          e(o).last().after(p);
      } else 0 === t.children().length && t.addClass(l + '_txtnode');
      t
        .children('a')
        .attr('role', 'menuitem')
        .click(function (t) {
      ...
      i.mobileNav.on('click', '.' + l + '_item', function (t) {
      ...
      e(i.btn).keydown(function (t) {
        ...
        switch (n.keyCode) {
          ...
          case o.DOWN:
            t.preventDefault(),
              (n.keyCode === o.DOWN && e(i.btn).hasClass(l + '_open')) ||
                i._menuToggle(),
              e(i.btn).next().find('[role="menuitem"]').first().focus();
        }
      }),
      i.mobileNav.on('keydown', '.' + l + '_item', function (t) {
        switch ((t || event).keyCode) {
          ...
          case o.RIGHT:
            t.preventDefault(),
              e(t.target)
                .parent()
                .hasClass(l + '_collapsed') && i._itemClick(e(t.target)),
          ...
          case o.LEFT:
            if (
              ...
              e(t.target)
                .parent()
                .parent()
                .hasClass(l + '_nav') && (i._menuToggle(), e(i.btn).focus());
            break;
          case o.ESCAPE:
    ...
    (a.prototype._menuToggle = function (e) {
      var t = this,
        n = t.btn,
        a = t.mobileNav;
      n.hasClass(l + '_collapsed')
        ? (n.removeClass(l + '_collapsed'), n.addClass(l + '_open'))
        : (n.removeClass(l + '_open'), n.addClass(l + '_collapsed')),
        n.addClass(l + '_animating'),
    ...
    (a.prototype._visibilityToggle = function (t, n, a, i, s) {
      ...
      var c = this,
        ...
        u = 0;
      a && (u = p.duration),
        t.hasClass(l + '_hidden')
          ? (t.removeClass(l + '_hidden'),
            s || p.beforeOpen(i),
            'jquery' === p.animations
    ...
    (a.prototype._getActionItems = function (e) {
      ...
      if (!t) {
        ...
        var n = e.children('li'),
          a = n.find('a');
        (t.links = a.add(n.find('.' + l + '_item'))), e.data('menu', t);
      }
      return t.links;
    }),
      ...
      if ('string' == typeof t && '_' !== t[0] && 'init' !== t) {
        ...
        return (
          this.each(function () {
            ...
            l instanceof a &&
              'function' == typeof l[t] &&
              (i = l[t].apply(l, Array.prototype.slice.call(n, 1)));
          }),
          void 0 !== i ? i : this
        );
      }
